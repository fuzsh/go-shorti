...
import (
	...
	"microservice-email/internal/api"
	"microservice-email/internal/lib"
...
func init() {
	...
	flag.StringVar(&lib.ConfigFilePath, "config-file", "config/microservice-email.conf.yml", "Configuration file path")
