...
// MsgContentType is content type in message queue
...
// NewRabbitMQ create new rabbit mq instance
...
// StartConsumer starts rabbit mq message channel consumer
